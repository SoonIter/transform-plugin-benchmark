...
function collectProgramImports(state: PluginState): void {
...
function defaultStyledIdentifier(state: PluginState): Identifier {
    ...
    if (declaration === null) {
        ...
        // Keep the currently traversed statement array stable.
        state.program.body = [declaration, ...state.program.body];
